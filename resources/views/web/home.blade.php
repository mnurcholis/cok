                ...
                <div class="row gx-md-8 gy-10 gy-md-13 isotope">
                    <div class="project item col-md-6 col-xl-4">
                        <figure class="rounded mb-6">
                            <img src="./assets_front/img/photos/sh9.jpg" srcset="./assets_front/img/photos/sh9@2x.jpg 2x"
                                alt="" />
                        ...
                        <div class="post-header">
                            ...
                            <h2 class="post-title h3 fs-22"><a href="./shop-product" class="link-dark">Nike
                                    Air Sneakers</a></h2>
                    ...
                    <div class="project item col-md-6 col-xl-4">
                        ...
                        <div class="post-header">
                            ...
                            <h2 class="post-title h3 fs-22"><a href="./shop-product" class="link-dark">Apple
                                    Watch</a></h2>
                    ...
                    <div class="project item col-md-6 col-xl-4">
                        ...
                        <div class="post-header">
                            ...
                            <h2 class="post-title h3 fs-22"><a href="./shop-product" class="link-dark">Colorful
                                    Sneakers</a></h2>
                            <p class="price"><span class="amount">$55.00</span></p>
                        </div>
                        <!-- /.post-header -->
                    ...
                    <div class="project item col-md-6 col-xl-4">
                        ...
                        <div class="post-header">
                            ...
                            <h2 class="post-title h3 fs-22"><a href="./shop-product" class="link-dark">Polaroid
                                    Camera</a></h2>
                            <p class="price"><span class="amount">$55.00</span></p>
                        </div>
                        <!-- /.post-header -->
                    ...
                    <div class="project item col-md-6 col-xl-4">
                        ...
                        <div class="post-header">
                            ...
                            <h2 class="post-title h3 fs-22"><a href="./shop-product" class="link-dark">Curology
                                    Cleanser</a></h2>
                            <p class="price"><span class="amount">$55.00</span></p>
                        </div>
                        <!-- /.post-header -->
                    ...
                    <div class="project item col-md-6 col-xl-4">
                        ...
                        <div class="post-header">
                            ...
                            <h2 class="post-title h3 fs-22"><a href="./shop-product" class="link-dark">Q&Q Wall
                                    Clock</a></h2>
                            <p class="price"><span class="amount">$55.00</span></p>
                        </div>
                        <!-- /.post-header -->
                    ...
                    <div class="project item col-md-6 col-xl-4">
                        ...
                        <div class="post-header">
                            ...
                            <h2 class="post-title h3 fs-22"><a href="./shop-product" class="link-dark">Earphones</a>
                            </h2>
                            <p class="price"><span class="amount">$55.00</span></p>
                        </div>
                        <!-- /.post-header -->
                    ...
                    <div class="project item col-md-6 col-xl-4">
                        ...
                        <div class="post-header">
                            ...
                            <h2 class="post-title h3 fs-22"><a href="./shop-product" class="link-dark">Apple Watch
                                    Milano Loop</a></h2>
                            <p class="price"><span class="amount">$55.00</span></p>
                        </div>
                        <!-- /.post-header -->
