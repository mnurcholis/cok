    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Tambah Paket CCTV</h5>
                        <form id="uploadForm" action="{{ route('upload-paketcctv') }}" method="POST"
                            enctype="multipart/form-data">
                            @csrf
                            <div class="row mb-3">
                                <label for="nama" class="col-sm-2 col-form-label">Nama Paket CCTV</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="nama" name="nama"
                                        placeholder="Nama Paket CCTV" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="description" class="my-editor form-control" id="description" cols="50" rows="8"></textarea>
                                </div>
                            </div>
